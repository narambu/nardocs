...
The App Layer provisions the [composites](../composites/aws.html) that run your application and provides actions to deploy your code.
...
See [Composites](../composites/aws.html) for the full list of resources created.
