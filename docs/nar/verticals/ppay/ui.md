...
- UI Payment pages from [payments](/nar/verticals/common/uipackages/payments) package
...
Most pages come from the shared [payments](/nar/verticals/common/uipackages/payments) package.
...
This vertical imports both [uicommon](/nar/verticals/common/uipackages/uicommon) and [payments](/nar/verticals/common/uipackages/payments). The aliases are configured in `vite.config.ts`:
